  ...
  state:{
    diaryData:[
      ...
      },
      {
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 1, "tagName": "学习", "color": "#9C27B0" }
        ]
      },
      {
        "diaryId": 5,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 2, "tagName": "美食", "color": "#F44336" },
          { "tagId": 2, "userId": 2, "tagName": "家庭", "color": "#FF9800" }
        ]
      },
      {
        "diaryId": 6,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 3, "tagName": "健康", "color": "#8BC34A" }
        ]
      },
      {
        "diaryId": 7,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 1, "tagName": "旅行", "color": "#4CAF50" },
          { "tagId": 2, "userId": 1, "tagName": "摄影", "color": "#E91E63" }
        ]
      },
      {
        "diaryId": 8,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 2, "tagName": "工作", "color": "#2196F3" },
          { "tagId": 2, "userId": 2, "tagName": "学习", "color": "#9C27B0" }
        ]
      },
      {
        "diaryId": 9,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 3, "tagName": "家庭", "color": "#FF9800" },
          { "tagId": 2, "userId": 3, "tagName": "旅行", "color": "#4CAF50" }
        ]
      },
      {
        "diaryId": 10,
        ...
        "diaryTags": [
          { "tagId": 1, "userId": 1, "tagName": "学习", "color": "#9C27B0" },
          { "tagId": 2, "userId": 1, "tagName": "文学", "color": "#795548" }
        ]
      }
    ]
  },
